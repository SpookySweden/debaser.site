...
export const HYPER_TEXT =
  'cursor-pointer text-[11px] font-bold leading-none text-[#0000ff] underline underline-offset-2 hover:bg-[#ffffcc] hover:text-ena';
...
export const HYPER_ARROW =
  'cursor-pointer px-1 text-[11px] font-bold leading-none text-ena hover:bg-[#ffffcc]';
